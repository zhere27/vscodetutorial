...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cbci.BillsPayment.ApplicationCore.Entities.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Cbci.BillsPayment.ApplicationCore.Entities.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Cbci.BillsPayment.ApplicationCore.Entities.CatalogBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Cbci.BillsPayment.ApplicationCore.Entities.CatalogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Cbci.BillsPayment.ApplicationCore.Entities.CatalogType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Cbci.BillsPayment.ApplicationCore.Entities.BasketItem", b =>
                {
                    b.HasOne("Cbci.BillsPayment.ApplicationCore.Entities.Basket")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Cbci.BillsPayment.ApplicationCore.Entities.CatalogItem", b =>
                {
                    b.HasOne("Cbci.BillsPayment.ApplicationCore.Entities.CatalogBrand", "CatalogBrand")
                        .WithMany()
                        .HasForeignKey("CatalogBrandId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Cbci.BillsPayment.ApplicationCore.Entities.CatalogType", "CatalogType")
                        .WithMany()
